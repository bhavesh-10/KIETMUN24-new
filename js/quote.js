document.addEventListener("DOMContentLoaded", function () {
    ...
    const quotes = [
      ...
      "A leader is one who knows the way,<br> goes the way and shows the way.<br> â€”John C. Maxwell",
      "Leadership is the capacity to<br> translate a vision into reality.<br> â€”Warren Bennis",
      "There are three essentials to leadership:<br> humility, clarity and courage.<br> â€”Chan Master Fuchan Yuan",
      "Do not follow where the path may lead.<br> Go instead where there is no path and leave a trail.<br> â€”Ralph Waldo Emerson",
      "Great leaders are not defined by the absence of weakness,<br> but rather by the presence of clear strengths.<br> â€”John Peter Zenger",
